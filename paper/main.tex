...
\begin{table}[t]
  \centering
  \caption{Ablation Study (Macro-MAP@10, HiRISE v3 Test Split)}
  \label{tab:ablation}
  \setlength{\tabcolsep}{4pt}
  \begin{tabular}{llc}
    \toprule
    Ablation               & Configuration              & Macro-MAP@10   \\
    \midrule
  ...
  \end{tabular}
  \vspace{2pt}
  \\\footnotesize A1 and A2 results available; A3/A4/A5 ablation variants pending additional runs.
\end{table}
