...
from each embedding.
Concretely, letting $c_x\!\equiv\!\cos\tfrac{x}{2}$ and
$s_x\!\equiv\!\sin\tfrac{x}{2}$, expanding the $SU(2)$ product gives
\begin{equation}
\RY(\beta)\RX(\alpha) =
\begin{pmatrix}
c_\beta c_\alpha - i s_\beta s_\alpha & -s_\beta c_\alpha - i c_\beta s_\alpha \\
s_\beta c_\alpha + i c_\beta s_\alpha &  c_\beta c_\alpha + i s_\beta s_\alpha
\end{pmatrix},
\end{equation}
